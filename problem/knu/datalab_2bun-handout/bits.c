 ...
 *          This is the file you will hand in to E-ruri.
 *
...
/* 
 * examine_fitness_twos_comple - return 1 if x can be represented as an 
 *  n-bit, two's complement integer.
 *   1 <= n <= 32
 *   Examples: examine_fitness_twos_comple(5,3) = 0, examine_fitness_twos_comple(-4,3) = 1
 *   Legal ops: ! ~ & ^ | + << >>
 *   Max ops: 15
 *   Rating: 2
 */
int examine_fitness_twos_comple(int x, int n) {
  return 2;
}
...
/* 
 * is_equal_float - Compute f == g for floating point arguments f and g.
 ...
 *   Rating: 2
 */
int is_equal_float(unsigned uf, unsigned ug) {
    return 2;
}
/* 
 * from_int_to_float - Return bit-level equivalent of expression (float) x
